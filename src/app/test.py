    ...
    for i in range(1,20):
        ...
        for word in words_list:
            if (levenshteinwtw("casa", word) <= int(tolerancia)):
                ...
                F.write("\n")
        time2 = time.time()
        F = open("../../tests_results/basura.txt", "w")
        timelist.append(time2 - time1)
    F2.write("\nMedia de tiempo: ")
    F2.write(str(media(timelist)))
    F2.write("\nDesviacion tipica de tiempo: ")
...
if __name__ == "__main__":
    ...
    Fresult = open("../../tests_results/resultlev.txt", "w", encoding='utf-8')
    Fresultdamerau = open("../../tests_results/resultdam.txt", "w", encoding='utf-8')
    Fresultdyn = open("../../tests_results/resultdynlev.txt", "w", encoding='utf-8')
    Fresultdyndamerau = open("../../tests_results/resultdyndam.txt", "w", encoding='utf-8')
    Fresultram = open("../../tests_results/resultramlev.txt", "w", encoding='utf-8')
    Fresultramdamerau = open("../../tests_results/resultramdam.txt", "w", encoding='utf-8')
    Ftime = open("../../tests_results/time.txt", "w")
